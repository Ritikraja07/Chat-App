    ...
    <div className="App">
      {show ? (
        < div className="joinChatContainer">
          ...
          <div>
            <p>The page is Developed By Mr. Ritik raja</p>
            <p><a href="mailto:ritik.rock121@gmail.com">Mail Me</a></p>
            <p>Using this Webapp you can send msg and voice msg to any person in the world,
              You can also share file like images, stickers, files and folders.
